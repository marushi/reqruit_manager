...
class EntrySheetRequestDetailPage extends StatelessWidget {
  final int index;

  EntrySheetRequestDetailPage({this.index});
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              Expanded(
                                child: Text(ChangeNotifierModel.requestListModel
  ...
  void _tapAnswerButtonAction(BuildContext context) async {
    ...
    try {
      await ChangeNotifierModel.requestListModel
          .changeRequestStatusToFirebase(RequestStatus.doing, index);
